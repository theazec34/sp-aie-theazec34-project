// src/utils/memory-persistence.ts
// Utilidades para persistencia de memoria contra amnesia de contexto

import { EmpleadoOnboarding, EventoAuditoria, LocalBrasaland, MesaRestaurante } from "../types/onboarding";
